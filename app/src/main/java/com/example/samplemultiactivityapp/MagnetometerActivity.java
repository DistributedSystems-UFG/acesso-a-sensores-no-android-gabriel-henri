...
public class MagnetometerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new MultiSensorAccess(sensorManager, textView, android.hardware.Sensor.TYPE_MAGNETIC_FIELD, "ufg/2025/magnetometer");

        TextView title = (TextView) findViewById(R.id.textView5);
        title.setText("Leitura do Sensor Magnetômetro");
    }
